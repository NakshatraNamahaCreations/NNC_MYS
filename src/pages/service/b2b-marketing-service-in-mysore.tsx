...
export default function B2BMarketPage() {
  ...
  return (
    <>
      ...
      <MyBreadcrumb crumbs={Service7Breadcrumbs} />
   ...
   <div className="row align-items-center justify-content-center g-4">
        ...
        <div className="col-12 col-lg-7">
          <div className={styles2["website-content"]}>
            <h2>
             Most driven B2B Marketing Service in Mysore
            </h2>
            <p>
             At Nakshatra Namaha Creations, our comprehensive design services
              cater to companies seeking to strengthen their brand presence and
              communicate their value propositions effectively in the competitive
              B2B landscape
            </p>
