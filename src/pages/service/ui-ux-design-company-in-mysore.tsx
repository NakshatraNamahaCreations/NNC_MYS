...
// NOTE: Keep any truly global styles (e.g., your FAQ/Bootstrap overrides from FaqAccordion.css)
// imported once in _app.tsx or app/layout.tsx.
...
export default function UIUXDevelopment() {
  ...
  <div className={`${styles1["website-overlay"]}`}>
   ...
   <div className="row align-items-center justify-content-center g-4">
      ...
      {/* FAQ — relies on global Bootstrap/Faq styles loaded in _app */}
